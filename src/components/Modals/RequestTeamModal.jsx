...
const RequestTeamModal = ({ onCloseModal, openModal }) => {
    ...
    >
      <div className="flex items-center pb-2">
        <h2 className="sm:text-2xl font-bold">
          Request to join FoodTech Aces Team
        </h2>
      </div>
      <div className="flex gap-5 max-md:flex-col mt-8">
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div className="flex gap-3">
            ...
            />
            <div className="flex flex-col">
              <h6 className="font-bold text-brown underline">FoodTech Aces</h6>
              <p className="text-xs">Ghent, Belgium</p>
              <p className="text-xs">Artificial Intelligence Foundation</p>
            </div>
          </div>
        </div>
      </div>
...
export default RequestTeamModal;
