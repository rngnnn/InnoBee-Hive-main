...
import ChallengeCard2 from '../../components/ChallengeComponent/ChallengeCard2';
...
const MyChallenges = () => {
	...
	return (
		<>
			<h4 className="y-3 font-semibold text-xl">My Challenges</h4>
			<p className="py-6">
				Access the challenges you created, manage the projects, and communicate
				with the challenge solvers.
			</p>
			...
			<div className="w-full flex flex-wrap py-8">
				{challenge?.map((challenge, index) => (
					<ChallengeCard2 key={index} challenge={challenge} index={index} />
				))}
			</div>
