...
const ReportThanks: React.FC<ReportThanksProps> = ({
	onStartNewReport,
	message,
}) => {
	...
	const helpCenterUrl = 'https://innobee.buzz/help-center';
	const supportEmail = 'support@innobee.buzz';
			...
			>
				<div className="bg-white rounded-lg p-6 shadow-md text-center">
					...
					<p className="text-sm text-gray-500 mb-4">
						Thank you for helping us keep InnoBee a safe platform. Your report
						has been submitted.
					</p>
					<div className="mb-4">
