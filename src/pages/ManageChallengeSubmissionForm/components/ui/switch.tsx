...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-5 w-12 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-pri-color disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-pri-color data-[state=unchecked]:bg-input",
      className
    )}
    {...props}
    ref={ref}
